...
# $Id: ncurses.mk,v 1.1.1.1 2007/03/18 23:23:58 srodgers Exp $
#
...
$(TARGET_DIR)/usr/lib/libncurses.a: $(STAGING_DIR)/lib/libncurses.a
	...
	cp -dpf $(NCURSES_DIR)/include/curses.h $(TARGET_DIR)/usr/include
	cp -dpf $(NCURSES_DIR)/include/eti.h $(TARGET_DIR)/usr/include
	cp -dpf $(NCURSES_DIR)/include/form.h $(TARGET_DIR)/usr/include
	cp -dpf $(NCURSES_DIR)/include/panel.h $(TARGET_DIR)/usr/include
	...
	cp -dpf $(NCURSES_DIR)/include/menu.h $(TARGET_DIR)/usr/include/
